...
- [x] analyze codebase scope (100%)
- [x] present 10 improvement ideas to user (100%)
- [x] update env.txt with new env variables (100%)
...
- [/] fix AttributeError in web/data_access.py get_available_tags [0%]
